...
if !exists("g:EclimHome")
  ...
  let g:EclimHome = '/home/szymonj/.eclipse/org.eclipse.platform_3.7.0_452209432/plugins/org.eclim_1.7.3'
  if has('win32unix')
...
if !exists("g:EclimEclipseHome")
  " set at build/install time.
  let g:EclimEclipseHome = '/home/szymonj/.eclipse/org.eclipse.platform_3.7.0_452209432'
  if has('win32unix')
